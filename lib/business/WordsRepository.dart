...
final myDictionary = [
  ...
  Word('filthy', 'грязный'),
  Word('slight', 'небольшой', translateSynonymous: ['незначительный']),
  Word('nifty', 'изящный'),
  Word('inexplicable', 'необъяснимый'),
  Word('nonchalant', 'беспечный', translateSynonymous: ['равнодушный']),
  Word('in no way', 'никоим образом'),
  Word('to revoke', 'отозвать (лицензию)'),
  Word('wiggle room', 'пространство для маневра'),
  Word('for God sakes', 'ради Бога', isIdiom: true),
  Word('tip of the iceberg', 'верхушка айсберга', isIdiom: true),
  Word('right on the money', 'прямо в яблочко', isIdiom: true),
  Word('mild', 'незначительный'),
  Word('coocky', 'самоуверенный', translateSynonymous: ['дерзкий']),
  Word('nobly', 'благородно'),
  Word('humbly', 'скромно'),
  Word('sloppy', 'небрежный'),
  Word('harsh', 'жестокий', translateSynonymous: ['суровыйй']),
  Word('humiliating', 'унизительно'),
  Word('poisonous', 'ядовитый'),
  ...
  Word('appointment', 'назначенная встреча'),
